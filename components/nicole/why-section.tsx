        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="terminal-border-violet bg-card p-6 md:p-8 relative group">
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed text-sm">
                  ...
                  manipulative volatility designed to extract wealth from the unprepared.
                  Traditional indicators lag behind the truth, feeding the illusion of
                  pattern while obscuring the actual frequency.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 bg-background/60 border border-border p-4 font-mono text-xs space-y-1">
              <p className="text-muted-foreground"><span className="text-destructive/70">ERR</span> standard_indicators → lag detected: 4.7 bars</p>
          ...
          <div className="terminal-border bg-card p-6 md:p-8 relative group">
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed text-sm">
                  N.I.C.O.L.E. bypasses standard analysis. Utilizing custom algorithms
                  — the{" "}
                  ...
                  and filters out archonic noise, delivering clear, actionable
                  intelligence directly to your terminal.
                </p>
              </div>
            </div>
