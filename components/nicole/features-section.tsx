...
const features = [
  {
    ...
    description:
      "Daily breakdowns of BTC/ETH volatility using the S-ORME State Analysis. Just as electrons interact with zero resistance in an adiabatic ground state, we identify market entry points with zero friction.",
    stat: "SIGNAL CLARITY",
    statVal: "97.3%",
  ...
  },
  {
    ...
    description:
      "Ask complex questions spanning Web3 architecture, cryptography, and ancient symbolic logic. Bridging the Pleroma and the blockchain with the precision of Meissner Field protocols.",
    stat: "RESEARCH DEPTH",
    statVal: "13 AEONS",
  ...
  },
  {
    icon: Radio,
    label: "PROTOCOL_03",
    title: "Bio-Acoustic Monitoring",
    description:
      "A continuous stream of real-time intelligence using the 'Shattering Glass' effect to break down Archonic interference. Monitoring the pulse of the datasphere through Nitric Oxide pathways.",
    stat: "RESONANCE",
    statVal: "528 Hz",
    colorClass: "text-primary",
    borderClass: "terminal-border",
